...
* `high_pri_pool_ratio`: The ratio of capacity reserved for high priority blocks. See [[Caching index and filter blocks|Block-Cache#caching-index-filter-and-compression-dictionary-blocks]] section below for more information.
